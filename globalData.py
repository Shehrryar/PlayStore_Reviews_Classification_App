...
STRGS = {
    'TITLE_PROGRAM' : "Smart factory Scheduling",
    'ITINERARIES' : "Tasks Set",
    'ADD_NEW' : "Add new",
    'ADD' : "Add",
    'EDIT' : "Edit",
    'DELETE' : "Delete",
    ...
    'MSG_WARN_NO_EXPORT':"Nothing to export! Create machines and tasks sets",
    'MSG_ERR_NO_MACH_CREATE' : "No machines were created!",
    'MSG_ERR_NO_MACH_NO_ITINERS' : "You can't create tasks set if there is no machines.",
    'MSG_ERR_ITINERARY_NO_NAME': "The Task has no name!",
    'MSG_ERR_ITINERARY_ENTER_NAME' : "Please, enter Task name.",
    'MSG_ERR_INVOLVE_TASK':"\nError involve element at: ",
    'TITLE_NEW_ITINERARIES' : "New task",
    'MSG_ERR_TASK_NO_NAME':"Task have no name!",
    'MSG_ERR_TASK_ENTER_NAME' : "Please, enter job name.",
    ...
    'ITINERARY_NAME' : "Task name:",
    'TASK_DETAIL' : "job detail",
    'NAME' : "Name:",
    'DURATION' : "Duration:",
    'ORDER':'Order:',
    'MACH':"Machine:",
    'PRIOR':"Priority:",
    'PER': "Period:",
    'SENVal': "Sensing Value:",
    'MACHS':"Machines:",
    'MACHS_ITINERARIES':"Machines in tasks sets",
    'SAVE': 'Save',
    ...
    'TITLE_NEW_TASK_INITERARY':"New task in Tasks Set",
    'TITLE_NEW_TASK':"Add job in Task",
    'NEW_TASK':"New task",
    'TASKS_INITERARY': "Jobs in Task",
    'TIMES_TASKS':"Times of jobs",
    'EXIT':"Exit",
    'M_FILE_IMPORT':"Import from file...",
    'M_FILE_EXPORT':"Export to file...",
    'ABOUT':"About",
    'ABOUT_TITLE':"About Smart Factory Scheduling",
    'ABOUT_MESG':"This is Smart Factory Scheduling with multiple machines",
    'SETUP':'Setup',
    'DATA':"Data",
    'ENTER_MATRIX_DATA':"Enter data in matrix",
    'CALC':"Calculate",
    'CREATED':"Created ",
    'REVIEWS_DATA':"PREPARED REVIEWS DATASET ",
    'NUM_MACHS':"Number of machines:",
    'NUM_ITINERS':"Number of tasks sets:"
    }
